...
if(isset($_POST['submit'])){
	...
	if($error){
		...
		//itt kell megcsinálni a fileba való írást
		$file = fopen('data/register.txt', 'a+'); //fájl helye és létrehozásának módja
		fwrite($file, $name.";".$email.";".$category.";".$date.";".$time."\r\n"); //fájl írás, mibe és mit
		fclose($file);  //Müvelet lezárása  puffer ürítés
